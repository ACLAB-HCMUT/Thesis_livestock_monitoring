...
const HEADER_GATEWAY_SEND_COW_GPS_AND_STATUS = 6

const HEADER_GATEWAY_REQUEST_SAFE_ZONES = 7
const HEADER_BACKEND_RESPONSE_SAFE_ZONES = 8

const HEADER_GATEWAY_SEND_COW_STATUS = 10
...
export default {
    ...
    HEADER_GATEWAY_SEND_COW_GPS_AND_STATUS,

    HEADER_GATEWAY_REQUEST_SAFE_ZONES,
    HEADER_BACKEND_RESPONSE_SAFE_ZONES,

    HEADER_GATEWAY_SEND_COW_STATUS,
}
